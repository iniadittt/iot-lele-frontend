		...
		<div>
			...
			<div className="xl:w-[1280px] mx-auto pt-6 py-16 px-4">
				<div className="grid xl:grid-cols-3 gap-4">
					<Card className={cn("@container/card", data.detail.kategori === "Baik" ? "bg-green-700 text-slate-50 border-green-500" : data.detail.kategori === "Sedang" ? "bg-blue-600 text-slate-50 border-blue-500" : data.detail.kategori === "Buruk" ? "bg-red-700 text-slate-50 border-red-500" : "")}>
